...
async function run(runtimeEnv, deployer) {
    // list of asset names
    const assetNames = [
        "Corgi Coin", "fst kech" ,"koar rox" ,"shiba inu"
    ];
    ...
    await Promise.all(assets.map(async (asset) => {
        ...
        const metadata = {
            ...
            image: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/Abdelhadi/assignment/arc3-nft-abderox/assets/nft/${asset.file}`,
            image_integrity: `sha256-${integrity.base64}`,
            image_mimetype: asset.image_mimetype,
            properties: {
                file_url: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/Abdelhadi/assignment/arc3-nft-abderox/assets/nft/${asset.file}`,
